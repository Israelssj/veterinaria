<div class="container">
	...
	<form method="post" class="form-horizontal col-md-6 col-md-offset-3" action="<?php echo site_url('crud/update_post')?>">
		...
		<div class="col-lg-12 text-center">
		  <div>
		    <h1>Actualizar datos dueño</h1> </br>          	
		  </div>
		</div>
			...
			<div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="text" name="fname" value="<?php echo $crud_data->first_name; ?>" class="form-control" idDuenio="fname" placeholder="Nombres"/>
			    </div>
			</div>
			...
			<div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="text" name="lname" value="<?php echo $crud_data->last_name; ?>" class="form-control" idDuenio="lname" placeholder="Apellidos" />
			    </div>
			</div>
			...
			<div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="email" name="email" value="<?php echo $crud_data->email_id; ?>" class="form-control" idDuenio="email" placeholder="Email" />
			    </div>
			</div>
			...
			<div class="col-sm-10">
			  <label>
			    <input type="radio" name="gender" idDuenio="optionsRadios1" <?php if($crud_data->gender == 'm'){ echo "checked";} ?> value="m"> Masculino
			  </label>
			  	  <label>
			    <input type="radio" name="gender" idDuenio="optionsRadios1" <?php if($crud_data->gender == 'f'){ echo "checked";} ?> value="f"> Femenino
			  </label>
			</div>
			</div>
			...
			<div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="text" name="numTelefono" value="<?php echo $crud_data->numTelefono; ?>" class="form-control" idDuenio="numTelefono" placeholder="Telefono a 10 digitos"/>
			    </div>
			</div>
			...
			<div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="text" name="direccion" value="<?php echo $crud_data->direccion; ?>" class="form-control" idDuenio="direccion" placeholder="Ingrese su direccion"/>
			    </div>
			</div>
			
			<input type="hidden" value="<?php echo $crud_data->idDuenio; ?>"  name="idDuenio" />
